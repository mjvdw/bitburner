...
function earn(ns) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let maxServerRam = ns.getServerMaxRam(server.hostname) > ns.getPurchasedServerMaxRam()
        ...
        if (!correctTarget) {
            ...
            let batchScripts = currentScripts.filter((s) => {
                return (s.filename != ns.getScriptName() && s.filename != "/scripts/999-sync.js");
            });
        ...
        for (let n in filteredPservs) {
            ...
            yield ns.scp(homeScripts, pserv);
            ...
            let correctTarget = ns.isRunning("/scripts/100-batch-controller.js", pserv, target);
            if (!correctTarget) {
...
function getHackableTargets(ns, targets) {
    ...
    let hackableTargets = targets.filter((t) => {
        ...
        return (hackingSkill >= t.requiredHackingSkill &&
...
//# sourceMappingURL=000-master-controller.js.map